...
/*
    Даны два массива целых чисел, a и b.
    Верните новый массив длиной 2, содержащий столько элементов из a, сколько поместится, а затем столько элементов из b, сколько поместится.
    Массивы могут быть любой длины, в том числе 0, но между двумя массивами должно быть 2 или более элементов.
